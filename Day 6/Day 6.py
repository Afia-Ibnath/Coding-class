...
rect1_width, rect1_height = 140, 140
top_left1 = (20, 20)  
...
cv2.putText(image_rgb, 'Center 1', (center1_x - 40, center1_y + 60), font, 0.6, (0, 255, 0), 2, cv2.LINE_AA)
cv2.putText(image_rgb, 'Center 2', (center2_x - 40, center2_y + 60), font, 0.6, (0, 0, 255), 2, cv2.LINE_AA)
